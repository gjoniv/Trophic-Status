...
setwd('~/Dropbox/Work stuff/Projects/Savina_size_scaling_project/2. code/NLA/')
#simulate some data
set.seed(20161110)
N<-100 #sample size
...
#run the model
m_hier<-stan(file="bayes_hierarchical_regression_example_2020_10_20.stan",data=list(N=N,J=J,K=K,id=id,X=X,y=y))
